...
MX_GPIO_Init (void)
{
  ...
  HAL_GPIO_WritePin (GPIOB, SELA_Pin | SELB_Pin | CTL1_Pin | CTL2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : SELA_Pin SELB_Pin CTL1_Pin CTL2_Pin */
  GPIO_InitStruct.Pin = SELA_Pin | SELB_Pin | CTL1_Pin | CTL2_Pin;
